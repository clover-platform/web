    ...
    return <HoverCard>
        ...
        <HoverCardContent side={"top"} className={"border-none p-0"}>
            ...
            <div className={"p-3 flex flex-wrap space-x-3"}>
                <div className={"space-x-2"}><span className={"text-secondary-foreground/50"}>{t("粉丝")}</span><span>0</span></div>
                <div className={"space-x-2"}><span className={"text-secondary-foreground/50"}>{t("关注")}</span><span>0</span></div>
            </div>
        </HoverCardContent>
    </HoverCard>
}

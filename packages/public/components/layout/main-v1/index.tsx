...
import { AdminLayoutLoading } from "@clover/public/components/layout/main-v1/loading";
import Sidebar, { SidebarProps } from "@clover/public/components/layout/main-v1/sidebar";
import {useAtom} from "jotai";
import {teamsState} from "@clover/public/state/public";
import {Guide} from "@clover/public/components/layout/main-v1/guide";
import classNames from "classnames";
import { useSidebarState } from "@clover/public/components/layout/main-v1/hooks";
import { LayoutNavbar } from "@clover/public/components/layout/main-v1/navbar";
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
export const MainLayout: FC<MainLayoutProps> = (props) => {
    ...
    return showGuide ? <Guide /> : <div className={"layout-admin flex justify-start w-full items-stretch min-h-[100vh]"}>
        ...
        <div className={classNames(
            ...
            <LayoutNavbar className={"sticky top-0 z-50 bg-white dark:bg-background"}>
                {
                    path ? <Breadcrumb>
                        <BreadcrumbList>
                            <BreadcrumbItem>

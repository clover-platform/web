  ...
  return <div className={"flex flex-wrap justify-center"}>
    {
      getSupportWay().map((item) => {
        return <a href={`${process.env.NEXT_PUBLIC_API_URL}/api/account/auth/link/${item.id}`} key={item.id}
          className={"my-[10px] mx-[15px] flex flex-col items-center justify-center"}>

...
import { addCollect, cancelCollect, deleteProject, leaveProject, list, type ProjectListParams } from '@/rest/project'
  ...
  return (
    <MainPage>
      <PageHeader>
        ...
        <TitleBar actions={actions} border={false} title={t('项目')} />
        <div className="-mb-md">
